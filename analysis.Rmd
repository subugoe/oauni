...
- plot of oa numbers on sectoral level (Is OA? plot), faceted, sort by pub. output
- faceted scatterplot publication output vs. OA share, sort by pub output
...
- oa categories on the national level (relative numbers); faceted / doged / lines ?
