...
## TODO: remove EMMI from Helmholtzplot, see if trendline still falls
...
secnames <- unique(oa_shares_inst_sec_boxplot$sec_abbr)
...
seccats <- unique(oa_shares_inst_sec_boxplot$sector_cat)
...
Significance groups: research against all others, practise against all others, mixed not well separated from universities (maybe sec_cat classification should be inst_cat, i.e. on the level of institutions - would have to be manually at least for some sectors)
